...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
		...
		KC_ESC,   KC_A,     KC_S,     KC_D,   KC_F,    KC_G,          KC_H,   KC_J,     KC_K, KC_L,    KC_QUOT, MT(MOD_RGUI, KC_QUOT),
		KC_LSFT,  MT(MOD_LCTL, KC_Z),     MT(MOD_LGUI, KC_X),     KC_C,   KC_V,    KC_B,          KC_BSPC,  KC_N,     KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,
		KC_LCTL,  KC_LALT,                    MO(1), KC_SPC,	          KC_ENT, MO(1),                          KC_RGUI, KC_RCTL
    ),

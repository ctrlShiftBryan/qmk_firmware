 ...
 */
 ...
 [_1U] = LAYOUT_ortho_5x14(
  KC_EQL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_GRV, KC_DEL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC, KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS, \
  KC_ESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_UP, KC_DOWN, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, MT(MOD_RGUI, KC_QUOT),  \
  KC_LSFT, MT(MOD_LCTL, KC_Z),    MT(MOD_LGUI, KC_X),   MT(MOD_LALT, KC_C),    KC_V,    KC_B,    KC_LEFT,  KC_RIGHT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
  KC_1, KC_2, MO(1),   MO(1), KC_SPACE,  KC_SPACE,  KC_BSPC,  KC_LALT,  KC_LALT,  KC_ENT, KC_A, MO(1),   KC_C, KC_D  \
 ),

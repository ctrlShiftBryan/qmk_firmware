...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
		...
		KC_TAB, KC_Q, KC_W, KC_E, RESET, KC_T, KC_RBRC, KC_LBRC, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS,
		KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_PGDN, KC_QUOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_SCLN,  MT(MOD_RGUI, KC_QUOT) ,
		RESET, KC_LSFT, MT(MOD_LCTL, KC_Z), MT(MOD_LGUI, KC_X) , KC_C, KC_V, KC_B, KC_F12, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
		LT(1, KC_GRV), KC_LGUI, KC_LEFT, KC_RGHT, KC_SPC, KC_SPC, KC_BSPC, KC_LALT, KC_ENT, KC_ENT, KC_UP, KC_DOWN, MT(KC_RGUI, KC_LBRC), MT(KC_RCTL, KC_RBRC))
};

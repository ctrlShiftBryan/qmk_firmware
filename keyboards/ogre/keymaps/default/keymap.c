...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_MINS, KC_6, KC_7, KC_8, KC_9, KC_0, KC_PGUP,
    ...
    KC_QUOT, KC_H, KC_J, KC_K, KC_L, KC_SCLN,  MT(MOD_RGUI, KC_QUOT) ,
		KC_ESC, KC_LSFT, MT(MOD_LCTL, KC_Z), MT(MOD_LGUI, KC_X) , KC_C, KC_V, KC_B,
    KC_DEL, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
		MT(MOD_LCTL, KC_GRV), KC_LGUI, KC_LEFT, KC_RGHT, LT(1, KC_SPC), KC_SPC, KC_BSPC,
    KC_LALT, KC_ENT, LT(1, KC_ENT), KC_UP, KC_DOWN, MT(KC_RGUI, KC_LBRC), MT(KC_RCTL, KC_RBRC)),

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_default(
    ...
    KC_PGDN, KC_ESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          MT(MOD_RGUI, KC_QUOT),
             KC_LSFT, MT(MOD_LCTL, KC_Z),    MT(MOD_LGUI, KC_X),    KC_C,    KC_V,    KC_B,             KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RGUI,
             MT(MOD_LCTL, KC_GRV),          LT(1, KC_SPC), KC_SPC,  KC_BSPC,                          KC_ENT,           LT(1, KC_ENT),          KC_RCTL
  ),
  ...
  [_FN1] = LAYOUT_default(
    ...
    RGB_RMOD, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,          KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______, _______,          _______,
              _______, BL_INC,  BL_DEC,  BL_TOGG, BL_BRTG, _______,          RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_HUI, RGB_HUD, _______, _______,
